...
b.prototype.insert_element_normal = function(name, attributes, namespace) {
	...
	last(this.open_elements).appendChild(element);
...
b.prototype.insert_element_from_table = function(name, attributes, namespace) {
	var element = this.createElement(name, attributes, namespace)
	if(HTML5.TABLE_INSERT_MODE_ELEMENTS.indexOf(last(this.open_elements).tagName.toLowerCase()) != -1) {
...
b.prototype.insert_comment = function(data, parent) {
    try {
        ...
        if(!parent) parent = last(this.open_elements);
...
b.prototype.insert_text = function(data, parent) {
	...
	if(!this.insert_from_table || HTML5.TABLE_INSERT_MODE_ELEMENTS.indexOf(last(this.open_elements).tagName.toLowerCase()) == -1) {
...
b.prototype.generateImpliedEndTags = function(exclude) {
	...
	var name = last(this.open_elements).tagName.toLowerCase();
...
b.prototype.reconstructActiveFormattingElements = function() {
	...
	while(true) {
		...
		if(element == last(this.activeFormattingElements)) break;
	}
