...
Parser.prototype.parse = function(source) {
	...
	this.setup(this.inner_html, null, this.inner_html);
	this.tokenizer.tokenize();
}

Parser.prototype.parse_fragment = function(source, element) {
	// Check to make sure element is inside document
	this.tokenizer = new HTML5.Tokenizer(source, this.document);
	this.inner_html = element.tagName;
	this.setup(this.inner_html, null, this.inner_html);
	this.tokenizer.tokenize();
}
...
Parser.prototype.setup = function(inner_html, encoding, container) {
