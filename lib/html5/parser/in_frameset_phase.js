...
p.prototype.endTagFrameset = function(name, attributes) {
	if(this.tree.open_elements[this.tree.open_elements.length - 1].tagName == 'html') {
		// inner_html case
	...
	if(!this.parser.inner_html && this.tree.open_elements[this.tree.open_elements.length - 1].tagName != 'frameset') {
