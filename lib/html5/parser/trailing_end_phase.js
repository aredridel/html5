...
exports.Phase = p = function TrailingEndPhase(parser, tree) {
...
p.prototype.processCharacters = function(data) {
	this.parser_error('expected-eof-but-got-char');
