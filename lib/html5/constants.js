...
var PHASES = HTML5.PHASES = {
	initial: require('./parser/initial_phase'), 
	beforeHTML: require('./parser/before_html_phase'),
	beforeHead: require('./parser/before_head_phase'), 
	inHead: require('./parser/in_head_phase'),
	afterHead: require('./parser/after_head_phase'),
	inBody: require('./parser/in_body_phase'),
	inTable: require('./parser/in_table_phase'),
	inCaption: require('./parser/in_caption_phase'),
	inColumnGroup: require('./parser/in_column_group_phase'),
	inTableBody: require('./parser/in_table_body_phase'),
	inRow: require('./parser/in_row_phase'),
	inCell: require('./parser/in_cell_phase'),
	inSelect: require('./parser/in_select_phase'),
	inSelectInTable: require('./parser/in_select_in_table_phase'),
	afterBody: require('./parser/after_body_phase'),
	inFrameset: require('./parser/in_frameset_phase'),
	afterFrameset: require('./parser/after_frameset_phase'),
	afterAfterBody: require('./parser/after_after_body_phase'),
	afterAfterFrameset: require('./parser/after_after_frameset_phase'),
	inForeignContent: require('./parser/in_foreign_content_phase'),
	trailingEnd: require('./parser/trailing_end_phase'),
	rootElement: require('./parser/root_element_phase'),
};
