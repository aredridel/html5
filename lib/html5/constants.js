...
HTML5.DOM = browser.browserAugmentation(require('jsdom/level1/core').dom.level1.core) 
...
HTML5.PHASES = PHASES = {
	...
	trailingEnd: require('html5/parser/trailing_end_phase').Phase,
	rootElement: require('html5/parser/root_element_phase').Phase,
};
